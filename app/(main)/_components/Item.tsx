...
const Item = ({
  ...
  //create a note through create mutation
  const create = useMutation(api.documents.create);

  //onClick to create a note
  ...
  //delete a note through archive muation (archive in trash box, not deleted completely)
  const archive = useMutation(api.documents.archive);

  //onClick to delete a note (temporarily)
